...
const FEATURES = [
  {
    ...
    desc: 'Uses your device GPS to pinpoint your exact position — no manual input needed.',
    color: '#00d4ff',
  },
  {
    icon: '🔄',
    title: 'Real-time Shop Discovery',
    desc: 'Powered by OpenStreetMap\'s Overpass API for live, accurate business data.',
    color: '#10b981',
  },
  {
    icon: '🎛️',
    title: 'Smart Category Filtering',
    desc: 'Filter by 16 categories — restaurants, pharmacies, banks, gyms, and more.',
    color: '#f59e0b',
  },
  {
    icon: '📏',
    title: 'Distance Control',
    desc: 'Set your search radius from 5 km to 15 km and sort results by proximity.',
    color: '#8b5cf6',
  },
  {
    icon: '🗺️',
    title: 'Map & Table Views',
    desc: 'Switch between an interactive Leaflet map and a detailed sortable table.',
    color: '#ec4899',
  },
  {
    icon: '🧭',
    title: 'Turn-by-turn Directions',
    desc: 'Get directions via OpenStreetMap or Google Maps with a single click.',
    color: '#3b82f6',
  },
  {
    icon: '🔐',
    title: 'Admin Dashboard',
    desc: 'Admins can review user submissions, approve or decline requests, and control icon visibility.',
    color: '#ef4444',
  },
  {
    icon: '🆓',
    title: 'Completely Free',
    desc: 'No API keys, no usage limits, no billing. 100% open-source data.',
    color: '#14b8a6',
  },
];

const TECH_STACK = [
  { name: 'React 18', role: 'UI framework', icon: '⚛️', color: '#61dafb' },
  { name: 'React Router v6', role: 'Client-side routing', icon: '🔀', color: '#ca4245' },
  { name: 'Leaflet + React-Leaflet', role: 'Interactive maps', icon: '🗺️', color: '#199900' },
  { name: 'OpenStreetMap', role: 'Map tiles & geodata', icon: '🌍', color: '#7ebc6f' },
  { name: 'Overpass API', role: 'Shop data queries', icon: '🔍', color: '#f59e0b' },
  { name: 'Nominatim', role: 'Reverse geocoding', icon: '📌', color: '#8b5cf6' },
  { name: 'Browser Geolocation API', role: 'Device location', icon: '📡', color: '#3b82f6' },
  { name: 'localStorage', role: 'Admin settings persistence', icon: '💾', color: '#10b981' },
];
...
const PRIVACY_POINTS = [
  {
    ...
    desc: 'We do not collect, store, or transmit your personal data or location to any server.',
  },
  {
    icon: '🖥️',
    title: 'Browser-only Processing',
    desc: 'All location logic runs entirely in your browser. Your coordinates never leave your device.',
  },
  {
    icon: '🍪',
    title: 'No Cookies or Tracking',
    desc: 'We use no analytics, advertising cookies, or third-party trackers of any kind.',
  },
  {
    icon: '💾',
    title: 'Local Storage Only',
    desc: 'Admin icon preferences are saved in your browser\'s localStorage — never on a remote server.',
  },
  {
    icon: '🔓',
    title: 'Open Source Data',
    desc: 'All map and shop data comes from OpenStreetMap, a public, community-maintained dataset.',
  },
  {
    icon: '⚡',
    title: 'Permission-based',
    desc: 'Location access is requested explicitly. You can deny it at any time without losing app functionality.',
  },
];
  ...
  return (
    <div className="about-container">
        ...
        <div className="about-panel">
          <div className="privacy-hero">
            ...
            <p>
              ...
              and no interest in your personal data. Here's exactly what that means in practice.
            </p>
          </div>
      ...
      {activeTab === 'tech' && (
        <div className="about-panel">
          <p className="panel-intro">
            Built entirely on open-source and free technologies — no proprietary APIs, no vendor lock-in.
          </p>
          <div className="tech-grid">
            {TECH_STACK.map(t => (
              <div key={t.name} className="tech-card" style={{ '--tc': t.color }}>
          ...
          <div className="open-source-note">
            <span>🌐</span>
            <span>
              All map data is © <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener noreferrer">OpenStreetMap contributors</a>,
              available under the <a href="https://opendatacommons.org/licenses/odbl/" target="_blank" rel="noopener noreferrer">ODbL licence</a>.
            </span>
          </div>
        </div>
      )}
